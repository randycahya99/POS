...
<head>
  ...
  <link href="<?php echo e(asset('assets/adminpos/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
...
<!--         <div class="sidebar-brand-icon rotate-n-15">
        ...
        <div class="sidebar-brand-text mx-3">Si POS</div>
      </a>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a class="btn btn-primary" href="<?php echo e(url('/login')); ?>">Keluar</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <script src="<?php echo e(asset('assets/adminpos/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>

      <!-- Core plugin JavaScript-->
      <script src="<?php echo e(asset('assets/adminpos/vendor/jquery-easing/jquery.easing.min.js')); ?>"></script>

      <!-- Custom scripts for all pages-->
      <script src="<?php echo e(asset('assets/adminpos/js/sb-admin-2.min.js')); ?>"></script>
      ...
      <script src="<?php echo e(asset('assets/adminpos/js/demo/chart-pie-demo.js')); ?>"></script>
